...
public class CubeViewCopy extends View {
    ...
    public CubeViewCopy(Context context) {
        super(context);
        setWillNotDraw(false);
        init();
    }

    public CubeViewCopy(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setWillNotDraw(false);
        init();
    }

    public CubeViewCopy(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        setWillNotDraw(false);
        init();
    }

    public CubeViewCopy(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setWillNotDraw(false);
        init();
    }
    ...
    private class UpdateUI extends AsyncTask<Context, Void, TestActivity> {
        ...
        @Override
        protected TestActivity doInBackground(Context... contexts) {
            TestActivity activity = (TestActivity)contexts[0];
        ...
        @Override
        protected void onPostExecute(TestActivity activity) {
